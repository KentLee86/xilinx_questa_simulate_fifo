...
add wave -noupdate -expand -group Source -radix unsigned /tb_axis_fifo_example/dut/u_src/frameId
add wave -noupdate -expand -group Source -radix unsigned /tb_axis_fifo_example/dut/u_src/Count
...
WaveRestoreCursors {{Cursor 1} {128998 ps} 0}
...
update
WaveRestoreZoom {33840 ps} {259440 ps}
